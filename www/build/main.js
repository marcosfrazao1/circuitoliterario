...
var tutorial = /** @class */ (function () {
    ...
    tutorial = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tutorial',template:/*ion-inline-start:"C:\Users\professor\source\repos\circuitoliterario\src\pages\tutorial\tutorial.html"*/'<ion-header>\n\n  <ion-navbar color="light">\n\n    <button ion-button menuToggle="left" left>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title align="center">Circuito Literário em Rede</ion-title>\n\n    <button ion-button menuToggle="right" right>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="main-content">\n\n  <ion-content padding>\n\n    <div #viewerContainer\n\n         class="viewer-container">\n\n        <div #viewer\n\n             class="viewer">\n\n            <ng-container #pagesContainer>\n\n                <div #pageContainer\n\n                     class="page"\n\n                     [style.width.px]="pageContainerUnique.width"\n\n                     [style.height.px]="pageContainerUnique.height">\n\n\n\n                    <div class="canvas-wrapper"\n\n                         #canvasWrapper>\n\n                        <canvas class="page-canvas"\n\n                                #canvas></canvas>\n\n\n\n                    </div>\n\n                    <div #textContainer\n\n                         class="text-layer selectable">\n\n                    </div>\n\n                </div>\n\n            </ng-container>\n\n        </div>\n\n    </div>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\professor\source\repos\circuitoliterario\src\pages\tutorial\tutorial.html"*/
        }),
...
var Timeline = /** @class */ (function () {
    ...
    Timeline = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-timeline',template:/*ion-inline-start:"C:\Users\professor\source\repos\circuitoliterario\src\pages\timeline\timeline.html"*/'<ion-header>\n\n  <ion-navbar color="light">\n\n    <button ion-button menuToggle="left" left>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title align="center">Circuito Literário em Rede</ion-title>\n\n    <button ion-button menuToggle="right" right>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="main-content">\n\n  <ion-card>\n\n    <timeline endIcon="call">\n\n      <timeline-item *ngFor="let item of items">\n\n        <timeline-time [time]="item.time"></timeline-time>\n\n        <ion-icon [name]="item.icon"></ion-icon>\n\n        <ion-card width="400">\n\n          <ion-card-header align="center">\n\n           {{item.title}}\n\n          </ion-card-header>\n\n\n\n          <ion-grid>\n\n              <ion-row>\n\n                <ion-col>\n\n                  <img width="100%" height="100%" src="{{item.content}}">\n\n                </ion-col>\n\n\n\n                <ion-col align="justify">\n\n                    {{item.text}}\n\n                   \n\n                                      \n\n                </ion-col>\n\n\n\n              </ion-row>\n\n            </ion-grid>\n\n\n\n        </ion-card>\n\n      </timeline-item>\n\n    </timeline>\n\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\Users\professor\source\repos\circuitoliterario\src\pages\timeline\timeline.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */],
...
var Fale = /** @class */ (function () {
    ...
    Fale = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-fale',template:/*ion-inline-start:"C:\Users\professor\source\repos\circuitoliterario\src\pages\fale\fale.html"*/'<ion-header>\n\n  <ion-navbar color="light">\n\n    <button ion-button menuToggle="left" left>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title align="center">Circuito Literário em Rede</ion-title>\n\n    <button ion-button menuToggle="right" right>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="main-content">\n\n  <ion-card>\n\n    <div id="after_submit"></div>\n\n    <form name="formteste" action="" method="post">\n\n      \n\n           \n\n        \n\n\n\n          \n\n\n\n          <a href=\'http://www.diocesano.g12.br/fale-conosco\'> <img src=\'assets/imgs/fale.png\' alt="Descrição"/></a>\n\n          \n\n            \n\n              \n\n        \n\n      \n\n      </form>\n\n      \n\n      \n\n\n\n   \n\n  \n\n  </ion-card>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\professor\source\repos\circuitoliterario\src\pages\fale\fale.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], Fale);
    return Fale;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_timeline_timeline__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__toverux_ngx_sweetalert2__ = __webpack_require__(341);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TimelineComponent = /** @class */ (function () {
    ...
    TimelineComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'timeline',template:/*ion-inline-start:"C:\Users\professor\source\repos\circuitoliterario\src\components\timeline\timeline.html"*/'<div class="timeline">\n\n  <ng-content></ng-content>\n\n\n\n  <timeline-item>\n\n    <ion-icon class="" [name]="endIcon"></ion-icon>\n\n  </timeline-item>\n\n\n\n</div>'/*ion-inline-end:"C:\Users\professor\source\repos\circuitoliterario\src\components\timeline\timeline.html"*/
        }),
